...
# react-native-keyboard-aware-scroll-view-fix

<p>
<img src="https://travis-ci.org/APSL/react-native-keyboard-aware-scroll-view-fix.svg?branch=master" />
<img src="https://img.shields.io/npm/dm/react-native-keyboard-aware-scroll-view-fix.svg" />
<img src="https://img.shields.io/npm/dt/react-native-keyboard-aware-scroll-view-fix.svg" />
</p>

A ScrollView component that handles keyboard appearance and automatically scrolls to focused `TextInput`.

<p align="center">
<img src="https://raw.githubusercontent.com/killserver/react-native-keyboard-aware-scroll-view-fix/master/kasv.gif" alt="Scroll demo" width="400">
</p>
...
```shell
npm i react-native-keyboard-aware-scroll-view-fix --save
```

```shell
yarn add react-native-keyboard-aware-scroll-view-fix
```

## Usage
You can use the `KeyboardAwareScrollView`, the `KeyboardAwareSectionList` or the `KeyboardAwareFlatList`
...
Import ``react-native-keyboard-aware-scroll-view-fix`` and wrap your content inside
it:
